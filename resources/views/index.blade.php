...
@section('content')
    ...
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div class="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
            <div class="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
                <div class="max-w-xl mb-6">
                    <div>
                        <p
                            class="inline-block text-red-500  py-px mb-4 text-xs font-semibold tracking-wider uppercase rounded-full">
                            Brand new Movies
                        </p>
                    </div>
                    <h2
                        class="max-w-lg mb-6 font-poppins text-3xl text-gray-200 font-bold tracking-tight sm:text-4xl sm:leading-none ">
                    ...
                    <p class="text-base text-gray-200 md:text-lg">
                        Movie Database is a new movie database on the Internet. Our focus is on English-language films, but
                        also contains information on non-English films, low-budget and television films, TV series.
                    </p>
                </div>
        ...
        <a href="#scroll-down" aria-label="Scroll down"
