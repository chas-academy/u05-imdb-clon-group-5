...
<section>
    ...
    <div class="flex mt-9 max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
        ...
        <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <h1 class="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">REGISTER</h1>
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <a href="/login" class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or Login</a>
                <span class="w-1/5 border-b dark:border-gray-600 md:w-1/4"></span>
            </div>
        </div>
    </div>
